...
- Interactive elevation mesh: Mapterhorn Terrarium terrain tiles, https://mapterhorn.com/ and https://tiles.mapterhorn.com/tilejson.json (BSD-3-Clause service code; terrain data retains its source licences). Taiwan coverage is derived by Mapterhorn from the Department of Land Administration, Ministry of the Interior's 2024 edition 20-metre digital terrain model under the Taiwan Government Open Data Licence 1.0. Terrain tiles remain hosted by Mapterhorn and are not redistributed in this repository.
