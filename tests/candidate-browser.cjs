...
await page.locator('.topbar [data-view=validation]').click();assert.equal(await page.locator('.poll-meta strong').first().innerText(),'66 場');assert.ok((await page.locator('#candidateValidation').innerText()).includes('D00237'));
