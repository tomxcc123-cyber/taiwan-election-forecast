...
CANDIDATE_ABLATIONS = [
    ...
    # Incumbency challengers deliberately replace, rather than merely append to,
    # prior-winner status. This lets exceptional by-elections (for example
    # Kaohsiung 2020) alter the 2022 feature without double counting a stale
    # regular-election winner flag.
...
def run(panel, train_year=2018, test_year=2022, alpha_grid=DEFAULT_ALPHA_GRID):
    ...
    return {
        ...
        "notes": [
            "C0-C9 specifications are predeclared; the 2022 holdout is not used to select one inside this runner.",
