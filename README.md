...
最新版本為 `2026.09-multisource.1`：[多來源民調更新與限制](docs/MULTISOURCE_POLLS.md)。本輪由Codex核對美麗島4份原始問卷、8題，累計存檔15題、入模3題。美麗島自動索引請求受限時保留已核對資料，來源狀態明示；聯合報、中時、ETtoday尚未完成接入，不能視為已覆蓋。
